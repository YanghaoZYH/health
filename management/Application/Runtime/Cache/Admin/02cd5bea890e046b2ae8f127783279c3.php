...
<body>
<form method="post" action="/health/management/Application/index.php/Admin/doctor/listDoc/hos_id/64" id="listform">
          ...
          <td colspan="0">
    		...
    		<table class="dialogtable" cellspacing="0" cellpadding="0">
    			<tr>
	    			...
	    			<td class="layer-photos-demo"><?php showImage($v['doc_img'],120,80); ?></td>
	    		</tr>
	    		<tr>
	    			<td>医生名称：</td>
	    			<td><?php echo $v['doc_name']; ?></td>
