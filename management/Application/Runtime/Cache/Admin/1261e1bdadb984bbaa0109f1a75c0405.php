  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li>
        <a class="layui-btn layui-btn-primary" href="/health/management/Application/index.php/Admin/User/add"><i class="layui-icon">&#xe654;</i>  添加用户</a> </li>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn layui-btn-mini" href="/health/management/Application/index.php/Admin/User/edit/user_id/<?php echo $v['user_id']; ?>"><i class="layui-icon">&#xe642;</i>　修　改</a> 
          ...
          <div style="margin-top: 10px;margin-left: 0px">
          	  <a class="layui-btn layui-btn-primary layui-btn-mini" href="/health/management/Application/index.php/Admin/HistoryVis/listHis/user_id/<?php echo $v['user_id']; ?>/relative_id/0"><i class="layui-icon">&#xe642;</i>历史就诊</a>
			  <a class="layui-btn layui-btn-danger layui-btn-mini" href="/health/management/Application/index.php/Admin/User/edit/user_id/<?php echo $v['user_id']; ?>"><i class="layui-icon">&#xe63c;</i>用药日记</a>
			  <a class="layui-btn layui-btn-normal layui-btn-mini" href="/health/management/Application/index.php/Admin/relative/listRela/user_id/<?php echo $v['user_id']; ?>"><i class="layui-icon">&#xe612;</i>亲友管理</a>
          </div>
		  </td>
          <td colspan="0">
          	<!-- 详情页面 -->
