...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/healthSystem/Application/index.php/Admin/illness/edit/illness_id/2" name="fileUploadForm" enctype="multipart/form-data">
