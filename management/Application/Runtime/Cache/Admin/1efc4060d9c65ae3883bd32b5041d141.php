  ...
  <div class="panel admin-panel">
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn-primary" href="/health/management/Application/index.php/Admin/Auth/editAdmin/mg_id/<?php echo $v['mg_id']; ?>"><span class="icon-edit"></span> 修改</a>
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location="/health/management/Application/index.php/Admin/Auth/delAdmin/mg_id/"+id;
	}
}
