...
<body>
<form method="post" action="/healthSystem/Application/index.php/Admin/Hospital/listDep/hos_id/57.html" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-green icon-plus-square-o" href="/healthSystem/Application/index.php/Admin/hospital/addDep/hos_id/<?php echo I('get.hos_id'); ?>"> 添加科室</a></li>
      </ul>
    </div>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="button border-main" href="/healthSystem/Application/index.php/Admin/Hospital/editDep/hos_id/<?php echo $v['hos_id']; ?>/dep_id/<?php echo $v['dep_id']; ?>"><span class="icon-edit"></span> 修改</a> 　&nbsp
...
function del(id,hos_id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/Application/index.php/Admin/hospital/delDep/id/"+id+"/hos_id/"+hos_id;
	}
}
