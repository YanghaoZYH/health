...
<body>
<form method="post" action="/healthSystem/Application/index.php/Admin/Knowledge/listKnow" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-green icon-plus-square-o" href="/healthSystem/Application/index.php/Admin/Knowledge/add"> 添加知识</a> </li>
        <li>搜索：</li>
        <li>首页
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="button border-main" href="/healthSystem/Application/index.php/Admin/Knowledge/edit/know_id/<?php echo $v['know_id']; ?>"><span class="icon-edit"></span> 修改</a> 
...
function del(know_id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/Application/index.php/Admin/Knowledge/delete/know_id/"+know_id;
	}
}
