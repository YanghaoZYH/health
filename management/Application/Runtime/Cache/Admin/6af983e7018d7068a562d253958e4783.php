...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/healthSystem/Application/index.php/Admin/Department/add" name="fileUploadForm" enctype="multipart/form-data">
    <div class="div_tab" style="display:block;">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="dep_name" data-validate="required:请输入标题" />
