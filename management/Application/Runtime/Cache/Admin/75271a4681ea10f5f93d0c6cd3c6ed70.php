...
<form method="post" action="/health/management/Application/index.php/Admin/illness/listSick.html" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        
        <li> <a class="layui-btn layui-btn-primary" href="/health/management/Application/index.php/Admin/Illness/add"> <i class="layui-icon">&#xe654;</i>  添加疾病</a></li>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn layui-btn-mini" href="/health/management/Application/index.php/Admin/illness/edit/illness_id/<?php echo $v['illness_id']; ?>"><i class="layui-icon">&#xe642;</i> 修改</a>
