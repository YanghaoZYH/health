...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/health/management/Application/index.php/Admin/Auth/addAdmin" name="fileUploadForm" enctype="multipart/form-data">
    <div class="div_tab" style="display:block;">  
      <div class="form-group">
        ...
        <?php foreach ($group as $k => $v): ?>
          <span><?php echo $v['title']; ?> <input type="checkbox" name="group_id[]" value="<?php echo $v['id']; ?>"></span>
        <?php endforeach; ?>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="mg_admin" data-validate="required:请输入名称" />
          <span class="tips">*</span>
        </div>
      </div>
      <div class="div_tab">
        <div class="form-group" >
          ...
          <div class="field">
            <input type="text" class="input w50" value="" name="mg_password" data-validate="required:请输入密码" />
            <span class="tips">*</span>
          </div>
        </div>
      </div>
