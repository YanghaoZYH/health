...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/healthSystem/Application/index.php/Admin/Hospital/editDep/hos_id/57/dep_id/6" name="fileUploadForm" enctype="multipart/form-data">
    ...
    <input type="hidden" name="id" value="<?php echo $data['id']; ?>" />  
        ...
        <div class="field">
          <select name="dep_id">
              <option value="0">请选择</option>
                  <?php  foreach ($dep as $k => $v): if($data['dep_id']==$v['dep_id']) { $select = 'selected="selected"'; }else{ $select = ''; } ?>
      ...
      <div class="div_tab">
        <div class="form-group" >
          ...
          <div class="field">
            <textarea id="introduce" name="dep_introduce"><?php echo $data['dep_introduce']; ?></textarea>
            <div class="tips"></div>
          </div>
        </div>
      </div>
