...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/health/management/Application/index.php/Admin/Department/edit/dep_id/6" name="fileUploadForm" enctype="multipart/form-data">
