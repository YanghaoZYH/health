...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/healthSystem/Application/index.php/Admin/doctor/edit/doc_id/37/hos_id/54" name="fileUploadForm" enctype="multipart/form-data">
