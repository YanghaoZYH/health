...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/healthSystem/Application/index.php/Admin/Knowledge/add" name="fileUploadForm" enctype="multipart/form-data">
    ...
    <div class="div_tab" style="display:block;">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="know_title" data-validate="required:请输入标题" />
      ...
      <div class="div_tab">
        <div class="form-group" >
          ...
          <div class="field">
            <textarea id="introduce" name="know_content"></textarea>
            <div class="tips"></div>
          </div>
        </div>
      </div>
